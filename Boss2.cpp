...
Boss2::Boss2() : Character(L"EnemyBoss2")
{
	tag = L"Enemy";
	moveSpeed = 50.0f;
	moveStopSlip = 0.0f;
	...
	skills.push_back(new SkillBoss1(this, 12));
	skills.push_back(new SkillBoss2(this, 4));
	skills.push_back(new SkillBoss3(this, 40));
	skills.push_back(new SkillBoss4(this));
...
void Boss2::FixedUpdate(float fixedDeltaTime)
{
